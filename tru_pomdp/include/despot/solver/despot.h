...
public:
	...
	void BeliefUpdate(ACT_TYPE action, std::unique_ptr<SceneGraph> obs_scene_graph);
	// void BeliefUpdateExp(ACT_TYPE action, std::unique_ptr<SceneGraph> obs_scene_graph);
	// void BeliefUpdateCompl(ACT_TYPE action, std::unique_ptr<SceneGraph> obs_scene_graph);
